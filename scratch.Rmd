...
rproc <- Csnippet(stringr::str_interp("
  ...
  rate[4] = phi;        // rate of entering immune amnesia
  rate[5] = mu;             // natural I death
  rate[6] = gamma;             // recovery
...
paramnames <- c("R0","mu","sigma","phi","gamma","alpha","iota",
...
# I estimate phi as what was previously gamma (the original I to R rate) because
# it's essentially 1 / (duration (in years) of the acute measles symptoms), or
# say 1 year / 1.5 weeks ~ 30.4 (which is the He et al. 2010 MLE). I estimate
# our new gamma as 1 / (duration of proposed amnesia) = 1/(2 years) = 1/2. Mina
...
read.csv(text="
town,loglik,loglik.sd,mu,delay,sigma,phi,gamma,rho,R0,amplitude,alpha,iota,cohort,psi,S_0,E_0,I_0,A_0,R_0,sigmaSE
